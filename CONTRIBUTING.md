...
Developer's wiki is available at https://github.org.cosmicide/termux-packages/wiki.
...
- **Examining existing packages for potential issues**
  ...
  open new [issue](https://github.org.cosmicide/termux-packages/issues/new/choose).

- **Fixing known bugs**

  Take a look at https://github.org.cosmicide/termux-packages/issues. There many
  issue tickets having tag `bug report` or `help wanted`. They all are waiting
  to be resolved.

- **Submitting new packages**

  There are lots of unresolved [package requests](https://github.org.cosmicide/termux-packages/issues?q=is%3Aissue+is%3Aopen+label%3A%22package+request%22).
...
- **Donate**
  ...
  See https://github.org.cosmicide/termux-packages/wiki/Donate for details.
...
Open a new [issue](https://github.org.cosmicide/termux-packages/issues/new/choose)
...
- You have read https://github.org.cosmicide/termux-packages/wiki.
...
be blocked from contributing to [Termux](https://github.org.cosmicide) project.
...
More about `build.sh` variables you can read on [developer's wiki](https://github.org.cosmicide/termux-packages/wiki/Creating-new-package#table-of-available-package-control-fields).
